...
import { 
  Button, Card, CircularProgress, Grid, List, ListItem, ListItemText, Table, 
...
function AdminProducts() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        // console.log("pages/admin/products.js fetchData() data: \n", data);
  ...
  const createHandler = async () => {
    if (!window.confirm('Are you sure about creating a product?')) {
      return;
    }
    try {
              ...
              <ListItem>
                <Grid container alignItems="center">
                  ...
                  <Grid align="right" item xs={6}>
                    <Button onClick={createHandler} size="small" color="primary" variant="contained">
                      Create
                    </Button>
